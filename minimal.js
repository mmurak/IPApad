minimalDict = {
    "." : [['D'], ['C'], ],
    "/" : [['ABC'], ['AC'], ['ADC'], ],
    "[" : [['B', 'BC'], ['B', 'BC', 'C'], ['ABCD'], ['BC'], ['BA', 'BC', 'CD'], ['BA', 'BCD'], ],
    "]" : [['BADC'], ['A', 'AD', 'D'], ['BA', 'AD', 'CD'], ['BA', 'ADC'], ['AD'], ['A', 'AD'], ],
    ...
    "h" : [['BC', 'CD'], ['BCBAD'], ['BCD'], ['BC', 'BAD'], ],
    "i" : [['C', 'B'], ['BC', 'B'], ['D', 'A'], ['AD', 'A'], ],
    "í" : [['C', 'AB'], ['D', 'AB'], ['AD', 'AB'], ['BC', 'AB'], ],
    "ì" : [['AD', 'BA'], ['BC', 'BA'], ['C', 'BA'], ['D', 'BA'], ],
    "j" : [['ADC', 'A'], ['AD', 'A'], ['B', 'BC'], ['BC', 'B'], ['A', 'ADC'], ['A', 'AD'], ],
    ...
    "r" : [['BCBA'], ],
    "s" : [['ABADC'], ['ABCDC'], ],
    "t" : [['AD', 'BA'], ['AD', 'A'], ['BA', 'AD'], ['BA', 'BCD'], ['BCD', 'BA'], ],
    "u" : [['BCDAD'], ],
    "ú" : [['BCDAD', 'AB'], ],
    "ù" : [['BCDAD', 'BA'], ],
